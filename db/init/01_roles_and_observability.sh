...
: "${DB_MONITOR_PASSWORD:=$DB_PASSWORD}"
: "${DB_AUTH_USER:=aris_auth}"
: "${DB_AUTH_PASSWORD:=$DB_PASSWORD}"
: "${DB_MEDIA_USER:=aris_media}"
: "${DB_MEDIA_PASSWORD:=$DB_PASSWORD}"
: "${DB_USER_SERVICE_USER:=aris_user}"
: "${DB_USER_SERVICE_PASSWORD:=$DB_PASSWORD}"
: "${DB_POST_USER:=aris_post}"
: "${DB_POST_PASSWORD:=$DB_PASSWORD}"
: "${DB_CHAT_USER:=aris_chat}"
: "${DB_CHAT_PASSWORD:=$DB_PASSWORD}"
: "${DB_SUPPORT_USER:=aris_support}"
: "${DB_SUPPORT_PASSWORD:=$DB_PASSWORD}"
: "${DB_COMMUNITY_USER:=aris_community}"
: "${DB_COMMUNITY_PASSWORD:=$DB_PASSWORD}"
: "${DB_SEARCH_USER:=aris_search}"
: "${DB_SEARCH_PASSWORD:=$DB_PASSWORD}"
: "${DB_GAME_USER:=aris_game}"
: "${DB_GAME_PASSWORD:=$DB_PASSWORD}"
...
create_or_update_login_role "$DB_GAME_USER" "$DB_GAME_PASSWORD"
