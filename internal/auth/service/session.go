...
type SessionService interface {
	Create(ctx context.Context, userAccountID int64) (*models.Session, error)
...
func (s *sessionService) Create(ctx context.Context, userAccountID int64) (*models.Session, error) {
	if err := s.validateSession(userAccountID); err != nil {
		return nil, err
	}
