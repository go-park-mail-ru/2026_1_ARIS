...
func NewTicketService(ticketRepo supportrepo.TicketRepository, mediaRepo mediarepo.MediaRepo) TicketService {
	return &ticketService{ticketRepo: ticketRepo, mediaRepo: mediaRepo}
}
