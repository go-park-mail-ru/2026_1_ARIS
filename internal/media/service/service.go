...
var (
	...
	ErrUnsupportedContentType = xerrors.UnsupportedContentType
	ErrMediaNotFound          = xerrors.MediaNotFound
	ErrProfileNotFound        = xerrors.ProfileNotFound
)

var (
	ErrCantOpenFileStr = "failed open file"
)
...
func (s *Service) SaveFiles(ctx context.Context, input SaveFilesInput) ([]SavedFile, []FileError, error) {
	...
	if err != nil {
		return nil, nil, xerrors.ProfileNotFound
	}

	if res == nil {
		return nil, nil, errors.New("user microservice invalid")
	}
...
func (s *Service) saveFile(ctx context.Context, in SaveFileInput) (*SavedFile, error) {
	...
	createdMedia := models.NewMedia(in.Name, extension, mediaUUID, nil, mimeType, link, in.ProfileID)
...
func (s *Service) GetFile(ctx context.Context, mediaID int64) (*models.Media, error) {
	...
	if err != nil {
		if errors.Is(err, xerrors.MediaNotFound) {
