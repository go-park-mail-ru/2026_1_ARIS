...
MICROSERVICE_INFRA=db pgbouncer redis minio tarantool elasticsearch clickhouse
MICROSERVICE_EDGE=nginx
MICROSERVICE_MONITORING=prometheus grafana node-exporter postgres-exporter nginx-exporter nginxlog-exporter
