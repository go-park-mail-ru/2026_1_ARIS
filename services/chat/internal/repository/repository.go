...
//go:generate mockgen -source=repository.go -destination=mocks/repository_mock.go -package=mocks DB,ChatRepo,ChatMemberRepo,MessageRepo,MessageMediaRepo,StickerRepo,ReactionRepo
